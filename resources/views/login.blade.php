...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
            ...
            <div class="container overflow-hidden bg-light" style="border-radius: 15px;">
                <div class="row gx-20">
                    <div class="col-lg-6 d-flex col-lg-6 d-flex justify-content-center align-items-center bg-primary">
                    <div class="col">
                      <div class="row" style="margin-bottom: 40px; text-align: center; color: white; padding-top: 20px;">
                        <h3>Selamat Datang Di EasyLib</h3>
                        <p>Silahkan Login dengan akun anda dan mulai menjelajah bersama kami</p>
                      </div>
                      <div class="row" style="padding: 0px 60px 60px 60px;"><img src="img/login.png" alt="" width="547" height="327"></div>
                    </div>
                          ...
                          @csrf
                            <div class="form-group container-fluid">
                              <div style="text-align: center;"><img src="/img/logo-easylibs.svg" alt="" width="300" height="150"></div>
                                ...
                                <br><br><br>
                                <p class="text-center">New on our platform? <a href="/register" class="link-primary">Create an Account</a></p>
                                <br>
                            </div>
                        </form>
                    </div>
