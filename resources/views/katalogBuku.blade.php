                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="card-body">
                                    ...
                                    <!-- penggarang -->
                                    <p style="color: rgb(161, 161, 161);">{{$data->pengarang}}</p>
                                    <!-- ringkasan singkat bukunya -->
                                    <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                        Fugiat
                                        quis commodi architecto sapiente consequuntur alias, rerum nostrum. Incidunt
                                        ipsa
                                        quidem saepe, iure ex et provident? Magnam, amet eos! Qui est voluptates ipsa
                                        sapiente tenetur pariatur dicta necessitatibus, modi, enim vero exercitationem
                                    </p>
                                    <hr>
                                    <!-- penerbit -->
                                    ...
                                    <a href="/lihatDetail/{{$data->judul}}" class="btn btn-primary">Lihat Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
