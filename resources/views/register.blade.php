            ...
            <div class="col-lg-6 d-flex col-lg-6 d-flex justify-content-center align-items-center bg-primary">
                <div class="col" style="text-align: center;">
                    <div class="row" style="color: white;">
                        ...
                        <br>
                        <p>Nikmati Layanan Easy Library</p>
                    </div>
                    <div class="row">
                        <div><img src="img/regist.png" alt="" width="300" height="300"></div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <form action="/register" method="post" class="form-horizontal">
                    ...
                    <div class="form-group container-fluid">
                        <div style="text-align: center;"><img src="/img/logo-easylibs.svg" alt="" width="300"
                                height="150"></div>

                        <div class="mb-3">
                            <label for="inputNama" class="col-sm-4 col-form-label">Name</label>
                            <input type="nama" class="form-control @error('nama')
                              is-invalid
                            @enderror" name="nama" placeholder="Enter your Name" value="{{ old('nama') }}">
                        ...
                        <div class="mb-3">
                            ...
                            is-invalid
                          @enderror" name="email" placeholder="Enter your Email" value="{{ old('email') }}">
        ...
        <footer class="footer pb-3" style="background-color: #3F6AD8;">
            <div class="p-3 mb-2 text-white" style="background-color: #3F6AD8;">
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div>
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    </svg><span>Telkom University, Jl. Telekomunikasi No. 1, Terusan Buahbatu -
                                        Bojongsoang, <br>Sukapura, Kec. Dayeuhkolot, Kabupaten Bandung, Jawa Barat 40257
                                        </p>
                            </div>
                        </div>
                ...
                <div class="col-md-12 text-center text-white">
                    <p>Make with <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red"
