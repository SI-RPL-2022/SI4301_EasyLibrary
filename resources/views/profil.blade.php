...
<body style="background: #dddddd;">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <form action="/upload/foto/{{ auth()->user()->id }}" method="post"
                    ...
                    <div class="col" style="text-align: center;">
                        ...
                        <h3 class="mt-4" style="color:#3F6AD8">{{$total}}</h3>
                    </div>
    ...
    <div class="container mb-4">
        <div class="card">
            <form action="/upload/kyc/{{ auth()->user()->id }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" name="profilKYC" class="form-control" id="inputGroupFile01">
                    </div>
                    
                    @if (auth()->user()->kyc)
                        <a href="/download/kyc/{{ auth()->user()->id }}">Profil KYC {{ auth()->user()->nama_depan .' '. auth()->user()->nama_belakang }} .pdf</a>
                    @endif
